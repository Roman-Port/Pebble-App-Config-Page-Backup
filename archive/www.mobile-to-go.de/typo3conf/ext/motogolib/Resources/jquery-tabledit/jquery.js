...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    ...
                    action: 'EDIT_LIST_ENTITY'
                },
                delete: {
                    class: 'btn btn-sm btn-default',
                    html: '<span class="glyphicon glyphicon-trash"></span>',
                    action: 'DELETE_LIST_ENTITY'
                },
                save: {
        ...
        {
            var serialize = $table.find('.tabledit-input').serialize() + '&' + settings.prefix + '[CONTENT_ACTION]=' + action + 
