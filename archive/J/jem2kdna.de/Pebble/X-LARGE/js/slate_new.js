...
(function($, Sortable) {
  ...
  $.extend($.fn, {
    ...
    itemColor: function(options){
      ...
      var layout = [
        [false    , '#FFFFFF', '#FF0000', '#FFAA00', '#FFAA55', '#FFFF00', false     ],
        ['#00FF00', '#00FFFF', '#AAFFFF', '#00AAFF', '#0000FF', '#AA00FF', '#FFAAFF' ],
        [false    , '#FF00AA', '#FFAAAA', '#AA5500', '#AAAAAA', '#FFFFAA', false     ],
        [false    , false    , false    , '#000000', false    , false    , false     ],
      ];
